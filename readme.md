...
Feel free to use this for your own reference or learning. Just clone the repo or download the .ipynb files. The IPython notebooks can also be viewed online [here](http://nbviewer.ipython.org/github/shankarmsy/practice_KNN/blob/master/KNN%20with%20scikit-learn.ipynb).